...
### Procedimiento
-   [1. Registrar producto y establecer un SKU ](#registrar-producto-y-establecer-un-sku)
-   [2. Registrar variante de producto y establecer un SKU](#registrar-variante-de-producto-y-establecer-un-sku)
-   [3.  Verificar SKU](#3-verificar-sku)
### 1. Registrar producto y establecer un SKU
...
### 2. Registrar variante de producto y establecer un SKU
