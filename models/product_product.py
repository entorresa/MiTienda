...
class ProductTemplate(models.Model):
    ...
    mitienda_sincronizar_stock = fields.Boolean(string="Sincronizar stock", compute='_compute_sincronizar_stock', inverse='_set_sincronizar_stock', store=True, default=False, copy=False, tracking=True)
    ...
    @api.depends('product_variant_ids.mitienda_sincronizar_stock')
    def _compute_sincronizar_stock(self):
        self._compute_template_field_from_variant_field('mitienda_sincronizar_stock')

    def _set_sincronizar_stock(self):
        self._set_product_variant_field('mitienda_sincronizar_stock')
    ...
    def _get_related_fields_variant_template(self):
        ...
        res.extend(['mitienda_sku', 'mitienda_id', 'mitienda_sincronizar_stock'])
        return res
